...
- The mechanism of a camera
  ...
  - a camera uses such information to calculate what we should have seen from a certain point of view
  - with object shapes, positions, environment lighting, etc., the camera will compute colors of each pixels on the screen, as if we are seeing things directly from there; this process is called _rendering_
...
- Also change background color [TODO]
